...
# MDAS
X_train, X_test, y_train, y_test = model_process.none_mdas_process(train, test)
regr = base_model()
...
regr.fit(X_train, y_train)
y_pred = np.clip(regr.predict(X_test), 0, 1)
print('rmse of base model:{}'.format(rmse_score(y_test, y_pred)))
print('mae of base model:{}'.format(mean_absolute_error(y_test, y_pred)))

# Sampling model
X_train, X_test, y_train, y_test = model_process.sampling_process(train, test)
regr = base_model()
regr.fit(X_train, y_train)
y_pred = np.clip(regr.predict(X_test), 0, 1)
...
regr.fit(X_train, y_train)
y_pred = np.clip(regr.predict(X_test), 0, 1)
print('rmse of PCA:{}'.format(rmse_score(y_test, y_pred)))
print('mae of PCA:{}'.format(mean_absolute_error(y_test, y_pred)))

# TCA
X_train, X_test, y_train, y_test = model_process.tca_process(train, test)
regr = base_model()
regr.fit(X_train, y_train)
y_pred = np.clip(regr.predict(X_test), 0, 1)
print('rmse of TCA:{}'.format(rmse_score(y_test, y_pred)))
print('mae of TCA:{}'.format(mean_absolute_error(y_test, y_pred)))

# CORAL
X_train, X_test, y_train, y_test = model_process.coral_process(train, test)
regr = base_model()
regr.fit(X_train, y_train)
y_pred = np.clip(regr.predict(X_test), 0, 1)
print('rmse of CORAL:{}'.format(rmse_score(y_test, y_pred)))
print('mae of CORAL:{}'.format(mean_absolute_error(y_test, y_pred)))
